...
public:
    ...
    PropertyType get_type() const noexcept { return PropertyType::Int; }
...
template<typename Fn>
auto Results::dispatch(Fn&& fn) const noexcept
{
...
//        case Type::Link:   return fn((RowExpr*)0);
...
auto Results::first(Context& ctx)
{
    return dispatch([&](auto t) {
        ...
        return value ? ctx.box(*value) : ctx.null_value();
    });
}
